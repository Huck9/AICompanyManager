...
if (!empty($_POST)) {
    ...
    $stmt = $pdo->prepare("Insert into salesinvoice (invoiceNumber, contractorName, vatID, nettoValue, vatValue, bruttoValue, nettoValueOther, nettoOtherName, filename) values (?, ?, ?, ?, ?,?,?,?,?)");

        ...
        <div class="container">
            ...
            <form method="post" action="updateSalesInvoice.php?id=<?= $_GET['id'] ?>" enctype="multipart/form-data">
                <div class="inputs">
                    ...
                    Nazwa konrahenta: <input type="text" name="contractorName" value="<?= $invoice['contractorName'] ?>"
                                             class="standardInput"><br>
                    ...
                    Wartość netto w innej walucie: <input type="number" step="0.01" name="nettoValueOther"
                                                          value="<?= $invoice['nettoValueOther'] ?>"
                                                          class="standardInput"><br>
                    Skrót waluty: <input type="text" name="nettoOtherName" value="<?= $invoice['nettoOtherName'] ?>"
                                         class="standardInput"><br>
